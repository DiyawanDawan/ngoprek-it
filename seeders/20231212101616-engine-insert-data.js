    ...
    await queryInterface.bulkInsert("jadwal", [
      {
        ...
        lokasi_pendonoran: "Jl. Thamrin No. 456, Jakarta Pusat",        // TODO sender update tanggal
...

      {
        id_jadwal: nanoid(5),
        id_lokasi_pmi: idLokPmiValues[0],
        lokasi_pendonoran: "Jl. Thamrin No. 456, Jakarta Pusat",
...

      {
        ...
        lokasi_pendonoran: "Jl. Gatot Subroto No. 101, Jakarta Selatan",
...

      {
        ...
        lokasi_pendonoran: "Jl. Sudirman No. 123, Jakarta Pusat",
        jadwal_jam_mulai: "09:00:00",
